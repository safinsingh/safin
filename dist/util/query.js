    ...
    return __generator(this, function (_g) {
        switch (_g.label) {
            case 0:
                ...
                _b = ['https://api.github.com/graphql'];
                _e = {};
                _d = (_c = JSON).stringify;
                _f = {};
                return [4 /*yield*/, fs_1.promises.readFile(path_1.join(__dirname, 'query.graphql'), 'utf-8')];
            case 1: return [4 /*yield*/, _a.apply(void 0, _b.concat([(_e.body = _d.apply(_c, [(_f.query = _g.sent(),
                            _f)]),
                        _e.headers = {
                        ...
                        _e.method = 'POST',
                        _e)])).then(function (rawResponse) { return rawResponse.json(); })];
            case 2:
                response = _g.sent();
                return [2 /*return*/, response.data.user.repositories.edges
